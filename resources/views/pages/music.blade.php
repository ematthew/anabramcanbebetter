    ...
    <div class="container">
        <div class="row section-padding-80">
            <div class="col-md-12">
                <!-- Thumbnail -->
                    <div class="col-md-12">
                        <div style="background: url({{ $music->audio_art }});height: 320px; width: 400px;background-repeat: no-repeat;background-size: contain;"></div>
                        <p>
                            {!! $music->about_artiste !!}
                        </p>
                        <p>{!! $music->about_track !!}</p>
                    </div>
                    <!-- Event Content -->
                    <div class="col-md-12">
                        <div class="event-text">
                            <h5>{{ $music->artiste_name }} - {{ $music->track_title }}</h5>
